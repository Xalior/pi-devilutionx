...
//     devilutionx-defaults.ld pins to image offset 0x800. It ships with the
...
#define DEFAULTS_BLOCK_PLACEMENT \
    __attribute__ ((section (".dvl.defaults"), used, aligned (8)))
#else
