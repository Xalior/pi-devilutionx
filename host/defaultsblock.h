...
// rapi-bootloader/defaultsblock/defaultsblock.h, and is shared verbatim by
// every bare-metal Raspberry Pi game port in this family. It is reproduced
// here byte-compatibly so this kernel can be stamped by the same network
// loader.
//
